...
/* harmony import */ var _components_filters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/filters */ "./src/js/components/filters.js");
/* harmony import */ var _components_filters__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_filters__WEBPACK_IMPORTED_MODULE_2__);
...
var sidebar__btn = document.querySelectorAll('.shop__sidebar-btn');
var sidebar__item = document.querySelectorAll('.shop__sidebar-item');
sidebar__btn.forEach(function (el) {
  el.addEventListener('click', function () {
    var next = el.nextElementSibling;

    if (el.classList.contains('shop__sidebar-btn--active')) {
      next.style.height = 0;
      el.classList.remove('shop__sidebar-btn--active');
    } else {
      next.style.height = next.scrollHeight + 'px';
      el.classList.add('shop__sidebar-btn--active');
    }
  });
});
...
var shopBtns = document.querySelectorAll('.shop__button');
var shopBtnIcons = document.querySelectorAll('.shop__button-icon');
var shopItem = document.querySelectorAll('.shop__item');
var shopMiddle = document.querySelector('.shop__middle');
console.log(shopBtnIcons);
shopBtns.forEach(function (el) {
  el.addEventListener('click', function () {
    shopBtns.forEach(function (el) {
      el.classList.remove('shop__button--active');
    });

    if (el.classList.contains('shop__button--active')) {
      el.classList.remove('shop__button--active');
    } else {
      el.classList.add('shop__button--active');
    }
  });
});
shopBtnIcons.forEach(function (el) {
  el.addEventListener('click', function () {
    shopBtnIcons.forEach(function (el) {
      el.classList.remove('shop__button-icon--icons');
    });

    if (el.classList.contains('shop__button-icon--icons')) {
      el.classList.remove('shop__button-icon--icons');
    } else {
      el.classList.add('shop__button-icon--icons');

      if (el.classList.contains('shop__button-icon--line')) {
        shopItem.forEach(function (el) {
          el.classList.add('shop__item--line');
        });
        shopMiddle.classList.add('shop__middle--line');
        shopMiddle.classList.remove('shop__middle--grid');
      } else {
        shopItem.forEach(function (el) {
          el.classList.remove('shop__item--line');
        });
        shopMiddle.classList.remove('shop__middle--line');
        shopMiddle.classList.add('shop__middle--grid');
      }
    }
  });
});
...
var sidebarBtn = document.querySelector('.sidebar__open-btn');
var sidebar = document.querySelector('.shop__sidebar');
sidebarBtn.addEventListener('click', function () {
  if (sidebarBtn.classList.contains('sidebar__open-btn--active')) {
    sidebarBtn.classList.remove('sidebar__open-btn--active');
    sidebar.classList.remove('shop__sidebar--active');
  } else {
    sidebarBtn.classList.add('sidebar__open-btn--active');
    sidebar.classList.add('shop__sidebar--active');
  }
});
...
var shopMenu = document.querySelector('.shop__menu');
var shopSubMenu = document.querySelector('.shop__submenu');
var shopSubMenu2 = document.querySelectorAll('.shop__submenu-level2');
var shopSubMenu3 = document.querySelectorAll('.shop__submenu-level3');
shopMenu.addEventListener('click', function (e) {
  trgt = e.target;

  if (trgt.classList.contains('shop__menu')) {
    shopMenu.classList.toggle('shop__menu--active');
    shopSubMenu.classList.toggle('shop__submenu--active');
  }
});
shopSubMenu.addEventListener('click', function (e) {
  trgt = e.target;

  if (trgt.classList.contains('shop__submenu')) {
    shopSubMenu.classList.toggle('shop__submenu--opened');
    shopSubMenu2.forEach(function (el) {
      el.classList.toggle('shop__submenu-level2--active');
    });
  }
});
shopSubMenu2.forEach(function (el) {
  el.addEventListener('click', function (e) {
    ...
    if (trgt.classList.contains('shop__submenu-level2')) {
      el.classList.toggle('shop__submenu-level2--opened');
      next = el.lastElementChild.lastElementChild;
      next.classList.toggle('shop__submenu-level3--active');
    }
  });
});
